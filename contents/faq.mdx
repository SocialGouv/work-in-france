...
- Si c'est l’étudiant qui réalise la démarche : **le mandat écrit** l'autorisant à accomplir la demande en ligne de demande d’autorisation provisoire de travail (APT) au nom et pour le compte de l'employeur ([voir un modèle](https://work-in-france.incubateur.social.gouv.fr/static/pdf/mandat.pdf)).
...
- ou à l'adresse email du service de la main d'oeuvre étrangère qui a a instruit la demande initiale. Vous pouvez trouver cette addresse en bas de page du formulaire en ligne de demande d'APT, ou en vous connectant à votre espace privé [demarches-simplifiees.fr](https://www.demarches-simplifiees.fr/)
