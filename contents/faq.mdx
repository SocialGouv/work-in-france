...
- **Le.s document(s) autorisant le séjour en France :**
    ...
    - ou si le renouvellement du titre de séjour est en cours, ces 3 documents dans cet ordre : 
      ...
      - 3 - le récépissé de nouvelle demande de titre de séjour _(qui porte en règle générale la mention "n'est valable qu'accompagné du titre de séjour N°XXXYYY correspondant à l'ancien titre de séjour, ce qui explique le point 2)_
