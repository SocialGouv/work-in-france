...
- **Le.s document(s) autorisant le séjour en France :**
    ...
    _Remarque : en règle générale un récepissé porte la mention "n'est valable qu'accompagné du document n°XXXXXX qui correspond au titre de séjour (carte de séjour ou VLS-TS) que vous souhaitez prolonger. C'est la raison pour laquelle vous devez toujours fournir ces deux documents._
