          ...
          <Box px={0} width={1}>
            <Flex flexWrap="wrap">
              ...
              <Text fontSize={3} lineHeight="1.4" width={[1, 4 / 5]}>
                Site officiel de demande d’autorisation de travail. Service en version bêta, créé
                par le Ministère du Travail en collaboration avec les préfectures de département.
              </Text>
            </Flex>
          </Box>
